  ...
  paste(
    paste(
      p(
        ...
        "Bottom disturbance is physical change to the substrate as a result of wind farm activities, such as packing down sediment with piles or digging up sediment with anchors or jet plows. Changes in turbidity (i.e., measure of suspended particles in water) are considered water quality changes and are not included in bottom disturbance. Displacement of sediment around a structure is considered scouring and is not included in bottom disturbance."
        )
    ),
    ...
    paste(
      p(
        ...
        "Changes in vessel traffic include changes the abundance, densities, types, and routes of vessels compared to what currently exist, due to activities relating to the offshore wind facility or to displacement of other vessel operations as a result of offshore wind facility activities. This includes, but is not limited to, vessels operating in pre-construction site assessment surveys, construction activities, and maintenance activities. This also includes changes in fishing or shipping patterns in response to wind farm activities."
        )
    ),
    
    paste(
      p(
        strong("Effects on Fishery Target Species."),
        "Effects on fishery target species are changes in the abundance, distribution, and or/behavior of target fish species as a direct or indirect result of offshore wind energy development. Such changes are considered effects on fish and other organisms, but are a stressor to fisheries, potentially causing changes in fishery effort or loss of revenue."
        )
    ),
    ...
    paste(
      p(
        strong("EMF."),
        "Electromagnetic fields (EMF) can be generated by the cables that carry electricity from and between energy sources to power stations and may produce local distortions in Earth’s main electric and magnetic fields."
        )
    ),
    ...
    paste(
      p(
        strong("Impaired Safe Fishery Access."),
        "Impaired safe fishery access is an inability to safely access and operate within fishing grounds (e.g., impairment of navigational equipment, potential to catch buried cables in fishing gear and/or anchors, increased risk of collision with structures)."
      )
    ),
    
    paste(
      p(
        strong("Inadequate Infrastructure."),
        "Inadequate infrastructure includes situations in which offshore wind energy development may increase the strain on shoreside infrastructure such as ports and docks, fueling stations, fish processing facilities, and other related systems. Inadequate infrastructure also includes situations in which vessel infrastructure and equipment such as engines, global positioning systems, radar, fishing gear, and safety equipment may be insufficient to account for changes in fishing vessel behavior caused by the need to navigate around or through offshore wind energy facilities."
      )
    ),
    
    paste(
      p(
        strong("Insufficient Communications."),
        "Insufficient communication includes situations in which there is inadequate dialog, information sharing, workshops, and/or development of novel communication strategies between stakeholders, offshore wind energy developers, regulatory agencies, and/or advisory groups related to offshore wind energy projects."
      )
    ),
    
    paste(
      p(
        strong("Loss of Fishing Grounds."),
        "Loss of fishing grounds is loss or inaccessibility of usual fishing areas resulting from short- and long-term aspects of offshore wind energy development. Loss or inaccessibility could be due to factors such as physical barriers, difficulty in maneuvering or setting gear, and risk of gear damage or loss. Safety issues are considered impaired safe access and not included in loss of fishing grounds. Reduction in desirability of fishing grounds in association with changes in fish abundance, distribution, and/or behavior is considered an effect on fishery target species, defined above, and is not included in loss of fishing grounds."
      )
    ),
...
pot_effects_defs <-
  ...
  paste(
    ...
    paste(
      p(
        strong("Displacement."),
        "Displacement is avoidance of an area associated with offshore wind energy development by individuals or groups as a result of exposure to a stressor(s).
This can include short- or long-term effective loss of habitat (such as foraging or roosting grounds, calving/spawning grounds, and above- or below- water movement areas). This also includes barrier effects, in which individuals may alter local or long-distance movements to avoid aspects of offshore wind energy development (including offshore infrastructure and vessel traffic). Avoidance may occur at multiple scales including macro- (whole wind farm), meso- (turbines), and micro- (turbine blades) avoidance."
      )
    ),
    ...
    paste(
      p(
        ...
        "Community alteration is a change to the composition, structure, or function of an ecological community (a group of populations of multiple species occupying the same geographic area at the same time). Invasive species are non-native species that are introduced into a new environment as a result of offshore wind energy development and cause ecological and/or economic harm."
        )
    ),
...
implement_status_defs <-
  ...
  paste(
    p(
      strong("Field Tested."),
      "Field tested refers to a situation in which an activity has not been implemented in a real-world development situation but has been tested in another way, such as academic research or prototypes."    
      )
  ),
  ...
  paste(
    p(
      strong("Implemented."),
      "Implemented means that the activity was implemented in the source literature, but there was no testing or assessment indicated as to whether it was effective at reducing impacts on the resource of interest."    
      )
  ),
  ...
  paste(
    p(
      ...
      "Implemented and evidence of effectiveness means that the activity was (1) implemented in the source literature, and (2) found to be effective when tested or assessed for effectiveness at reducing impacts on the resource of interest."
      )
  ),
...
mit_heir_defs <-
  ...
  paste(
    p(
      strong("Minimization."),
      "Minimization aims to reduce the impacts. For example, sound dampening technology may reduce the amount of sound emitted into the environment, thus reducing the impact of sound on organisms."
    )
  ),
...
gen_mitpractices_defs <-
  paste(
    ...
    paste(
      p(
        strong("Barriers."),
        "Barriers include activities such that physical creation of an obstacle prevents or limits a stressor (e.g., sound, EMF) from propagating (e.g., bubble curtains to block sound, cable burial to block EMF, scour protection to block sediment movement)."
        )
    ),
    ...
    paste(
      p(
        ...
        "Siting and seasonality include activities that consider geographic location choices for long-term wind farm structures (e.g., macro- siting) and/or time of year of activities, including vessel activities. Micro-siting of turbines is considered a structure configuration topic rather than siting/seasonality."
        )
    ),
    ...
    paste(
      p(
        ...
        "Shutdown and low power include mitigation options that require stopping or reducing the power of an activity (e.g., shutdown of geophysical surveys when marine mammals are present, soft-start pile driving). This also includes curtailment of turbine operations but not feathering or increasing cut-in speed, which are included in turbine operation parameters."
        )
    ),
    ...
    paste(
      p(
        ...
        "Limit an activity includes mitigation options that do not fall into other categories and include a restriction in activity (e.g., avoiding pile driving at night, not using explosives)."
      )
    ),
    ...
    paste(
      p(
        ...
        "Structure configuration includes mitigation options that involve choices in turbine numbers and sizes, foundation types, and how turbines are arranged in space (e.g., micro-siting)."
        )
    ),
    ...
    paste(
      p(
        ...
        "Water quality management includes activities that are designed to avoid water quality impacts, such as following dumping and bilge water regulations."
        )
    ),
    ...
    paste(
      p(
        strong("Compensation."),
        "Compensation includes mitigation options that involve offsetting an impact through financial means or by restoration, enhancement, or other conservation measures offsite (e.g., outside of the project area)."
        )
    ),
    ...
    paste(
      p(
        ...
        "Turbine operation parameters include options that focus on movement of turbines (e.g., increased cut-in speed to avoid bats). Curtailment is not included in this category as it is considered a shutdown/low power activity."
      )
    ),
    ...
    paste(
      p(
        ...
        "Deterrence/attraction reduction mitigation options include efforts to actively discourage animals from approaching activities and/or structures (e.g., use of pingers) or reduce the attractiveness of activities or structures (e.g., avoid including nesting habitat on turbines, use colors not attractive to birds). This does not include choices in lighting meant to reduce attraction, which is considered a lighting alternative."
        )
    ),
    ...
    paste(
      p(
        ...
        "Lighting alternatives include choices in lighting that can minimize attraction or deter animals, including considerations like number and intensity of lights, lighting color, and periodicity."
        )
    ),
    ...
    paste(
      p(
        ...
        "Engagement/communication activities include outreach efforts, information sharing, research facilitation, and other efforts to inform and learn from stakeholders in ways that will minimize and avoid impacts of offshore wind energy development."
        )
    ),
    ...
    paste(
      p(
        ...
        "Fisheries safety mitigation options are direct actions to reduce hazards of offshore wind energy development to increase safety of people and vessels (e.g., safety protocols for designating vessel right-of-way, marking designated transit zones, and infrastructure modifications to improve offshore communication and reduce interference with navigational equipment). This does not include outreach, research, and information sharing efforts, which are considered engagement/communication."
        )
    )
  )
